...
// Update embedding models regularly
const EMBEDDING_OPTIONS = [
  ...
  },
  {
    ...
    label: "MiniLM-L6 (HF, fast)",
  },
  {
    provider: "nvidia",
    model: "nvidia/nv-embedqa-e5-v5",
    label: "NVIDIA nv-embedqa-e5",
  },
  {
    provider: "openai",
    ...
    api
      ...
      .then((s) => {
        ...
        const i = EMBEDDING_OPTIONS.findIndex(
          (o) =>
            o.provider === s.embedding_provider &&
            o.model === s.embedding_model,
        );
  ...
  async function save() {
    ...
    try {
      ...
      await api.setEmbeddings(
        EMBEDDING_OPTIONS[embedIdx].provider,
        EMBEDDING_OPTIONS[embedIdx].model,
      );
    ...
    <div className="panel p-4 space-y-3">
      ...
      <div>
        ...
        <select
          className="input"
          value={embedIdx}
          onChange={(e) => setEmbedIdx(Number(e.target.value))}
        >
